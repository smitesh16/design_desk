       ...
       <div class="authForm">
         <div class="form-group">
          ...
          <div class="form-group" style="display: flex;">
            <select name="countryCode" id="" class="form-control" style="width: 50%;border: 1px solid #000000 !important;box-sizing: border-box;border-radius: 10px;box-shadow: none !important;">
          ...
          <div class="form-group">
            ...
            <input type="hidden" id="active_status" value="<?= $passval; ?>">
            <span class="err-msg" id="allError" style="color: red"></span> 
          </div>
          <button class="authActon" type="button" onclick="register();">REGISTER</button>
       </div>
