...
September - 2020  </h1>
              ...
              <div class="authAction mb-4">
               ...
               <img src="<?= base_url(); ?>assets/UI/images/store.png" class="img-fluid px-4"> 
             </div>
           </div>
        </div>
      </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <img src="<?= base_url(); ?>assets/UI/images/Arrow.png">
              </button>

              <div class="modal-body">
                 <ul class="nav justify-content-center mb-4" role="tablist">
                  <li class="nav-item">
                      <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#register" role="tab"  aria-selected="false">Register</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link " id="home-tab" data-toggle="tab" href="#login" role="tab"aria-selected="true">Login</a>
                    </li>
                    
                  </ul>
                  <div class="tab-content px-4" id="">
                    <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="">
                      <form action="" method="get" accept-charset="utf-8">
                        <div class="form-group">
				            <input type="text" id="user_name" class="form-control" placeholder="Full Name">
				            <span class="err-msg" id="user_nameallError" style="color: red"></span> 
				          </div>
				          <div class="form-group">
				            <input type="email" id="user_email" class="form-control onlyemail" placeholder="Work Email ">
				            <span class="err-msg" id="user_emailError" style="color: red"></span> 
				          </div>
				          <div class="form-group" style="display: flex;">
				            ...
				            <input type="text" id="contact_number" class="form-control onlynum" maxlength="10" placeholder="Phone Number" style="width: 70%;">
				          ...
				          <div class="form-group">
				            ...
				            <span class="err-msg" id="passwordallError" style="color: red"></span> 
				          </div>
				          <div class="form-group">
				            ...
				            <!-- <span class="err-msg" id="allError" style="color: red"></span>  -->
				          </div>
                         <div class="form-group">
                          <button class="actionBth" type="button" onclick="register();">Submit</button>
                         </div>
                      </form>
                    </div>
                    <div class="tab-pane fade" id="login" role="tabpanel" aria-labelledby="">
                         <div class="form-group">
                         ...
                         <div class="form-group">
							<input type="password" id="loginpassword" class="form-control" placeholder="Password" autocomplete="off">
         					<span id="allError" style="color: red;"></span>
                         </div>
                         <div class="form-group">
                          <button class="actionBth" id="signin" type="button">Submit</button>
                         </div>
                    </div>
                  </div>
              </div>
