        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <button type="button" class="btn btn-outline-success" onclick="sell_filter();">Filter</button>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h4 class="card-title m-0">Sale Result</h4>
                                ...
                                <input type="hidden" value="Sale" id="tableName">
                            </div>
                          <div class="row">
